...
@if (session('success'))
<div class="alert   border border-success text-success alert-dismissible d-flex align-items-enter mb-2 fade show "
    style="z-index: 222;height: 55px;" role="alert">
            ...
            <div class="col-12">
                <div class="card mb-3 mb-md-4">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a class="btn btn-secondary" href="{{  route('product.create') }}">Create</a>
                    </div>
                            ...
                            <table class="table text-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="font-weight-semi-bold border-top-0 py-2">Brand</th>
                                        <th class="font-weight-semi-bold border-top-0 py-2">Availibility</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                           ...
                                           <div class="images d-flex">
                                               @if($product->images)
                                                   @foreach (json_decode($product->images) as $img)
                                                       <img src="{{ asset( $img) }}" alt="Product Image" width="50"
                                        ...
                                        <td class="py-3">{{ $product->availibility }}</td>
                                        ...
                                        <td class="py-3">
                                            <div class="position-relative">
                                                ...
                                                <a id="dropDownInvoker{{ $product->id }}" class="link-dark d-flex"
                                                    href="#" aria-controls="dropDown{{ $product->id }}"
                                                    aria-haspopup="true" aria-expanded="false"
                                                    data-unfold-target="#dropDown{{ $product->id }}"
