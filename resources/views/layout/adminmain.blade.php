...
<head>
    <!-- Title -->
    <title>Dashboard | CodeBeter</title>
    ...
    <!-- DEMO CHARTS -->
    <link rel="stylesheet" href="/admin/public/demo/chartist.css">
    <link rel="stylesheet" href="/admin/public/demo/chartist-plugin-tooltip.css">

    <!-- Template -->
    <link rel="stylesheet" href="/admin/public/graindashboard/css/graindashboard.css">
    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="/admin/public/img/logo-mini.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="/admin/public/img/logo-mini.png" alt="Graindashboard" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="/admin/public/img/logo.png" alt="Graindashboard" style="width: auto; height: 33px;">
            </a>
...
<main class="main">
    ...
    <aside id="sidebar" class="js-custom-scroll side-nav">
        <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
            ...
            <!-- Category -->
            <li class="side-nav-menu-item">
                <a class="side-nav-menu-link media align-items-center" href="{{ route('category.view') }}" >
              <span class="side-nav-menu-icon d-flex mr-3">
                <i class="gd-file"></i>
              </span>
            ...
            <!-- End Category -->
             ...
             <!-- Product -->
            <li class="side-nav-menu-item">
                <a class="side-nav-menu-link media align-items-center" href="{{ route('product.view') }}" >
              <span class="side-nav-menu-icon d-flex mr-3">
                <i class="gd-file"></i>
              </span>
...
<script src="/admin/public/graindashboard/js/graindashboard.js"></script>
<script src="/admin/public/graindashboard/js/graindashboard.vendor.js"></script>

<!-- DEMO CHARTS -->
<script src="/admin/public/demo/resizeSensor.js"></script>
<script src="/admin/public/demo/chartist.js"></script>
<script src="/admin/public/demo/chartist-plugin-tooltip.js"></script>
<script src="/admin/public/demo/gd.chartist-area.js"></script>
<script src="/admin/public/demo/gd.chartist-bar.js"></script>
<script src="/admin/public/demo/gd.chartist-donut.js"></script>
<script>
